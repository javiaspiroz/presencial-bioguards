...
// ----------- FAMILIAR -----------
    ...
    void initialize() {
    	...
    	setDatosPerfil();
    	identidad.setText("Bienvenido, " + adminLogueado.getNombre() + " " + adminLogueado.getApellidos());
...
// ------------------ PANEL FAMILIARES ------------------
 ...
 // ------------------ Funciones auxiliares ------------------
	private void buscarAdministradorLogueado() {
		// Se busca el administrador en funcion del usuario logueado;
		Vector<Administrador> administradores = Sistema.getUnico().getfListaAdministradores();
		for(Administrador a: administradores) {
			if (Sistema.getUnico().getUsuarioLogueado().getUsuario().equals(a.getDni())) {
				adminLogueado = a;
				break;
			}
		}
    ...
    private void setDatosPerfil() {    	
		...
		fechaNacimientoPerfil.setText(FuncionesAuxiliares.TimeStampToString(adminLogueado.getFechaNacimiento()));
    ...
    private void guardarDatosAdmin(boolean valido) {
    	if (valido && FuncionesAuxiliares.serializarArrayAJsonAdministradores()) {
